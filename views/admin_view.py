...
def admin_view(my_users_service):
    ...
    add_delete_frame = tk.Frame(window, bg="red", padx=20, pady=10)
    ...
    user_table.column("username", anchor="w")  # Set anchor to center
    user_table.heading("password", text="Password")
    user_table.column("password", anchor="w")  # Set anchor to center
    user_table.heading("first_name", text="First name")
    user_table.column("first_name", anchor="w")  # Set anchor to center
    user_table.heading("last_name", text="Last name")
    user_table.column("last_name", anchor="w")  # Set anchor to center
    user_table.heading("email", text="Email")
    user_table.column("email", anchor="w")  # Set anchor to center
